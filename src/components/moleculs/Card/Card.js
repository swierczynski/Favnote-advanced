...
const Card = ({id, title, created, twitterName, articleUrl, content, removeItem, pageContext}) => {
  ...
  return ( 
    <div className={styles.outsideWrapper} onClick={handleCardClick}>
      ...
      <Button secandary onClick={()=> removeItem(pageType, id)} >Remove</Button>
    </div>
   );
}
